...
!(function (window, document, undefined) {
  ...
  function testProps(A, e, t, n) {
    ...
    for (
      var o, d, a, s, l, c = ["modernizr", "tspan", "samp"];
  ...
  function testDOMProps(A, e, t) {
    ...
    for (var r in A)
      if (A[r] in e)
        return t === !1
          ? A[r]
          : ((n = e[A[r]]), is(n, "function") ? fnBind(n, t || e) : n);
    return !1;
  }
  function testPropsAll(A, e, t, n, r) {
    ...
    return is(e, "string") || is(e, "undefined")
      ? testProps(o, e, n, r)
      : ((o = (A + " " + domPrefixes.join(i + " ") + i).split(" ")),
        testDOMProps(o, e, t));
  }
  ...
  isSVG ||
    !(function (A, e) {
      ...
      function o(A, t, n) {
        ...
        return (
          (r = n.cache[A]
            ? n.cache[A].cloneNode()
            : m.test(A)
              ? (n.cache[A] = n.createElem(A)).cloneNode()
              : n.createElem(A)),
          !r.canHaveChildren || w.test(A) || r.tagUrn
            ? r
      ...
      function d(A, t) {
        ...
        t = t || i(A);
        for (
          var r = t.frag.cloneNode(), o = 0, d = n(), a = d.length;
          a > o;
          o++
        )
          r.createElement(d[o]);
  ...
  !(function () {
    ...
    Modernizr.addAsyncTest(function () {
      ...
      try {
        ...
        r || ((i = new t()), i.append(l), (r = i.getBlob())),
          (d = n.createObjectURL(r)),
          (o = new Worker(d)),
  ...
  (ModernizrProto.prefixedCSSValue = prefixedCSSValue),
    ...
    Modernizr.addAsyncTest(function () {
      function A(t) {
        ...
        n.removeEventListener("loadeddata", A, !1),
          addTest("audiopreload", r),
  ...
  Modernizr.addTest("todataurljpeg", function () {
    ...
    Modernizr.addTest("csspositionsticky", function () {
      var A = "position:",
        ...
        n = t.style;
      return (
        (n.cssText = A + prefixes.join(e + ";" + A).slice(0, -A.length)),
    ...
    Modernizr.addTest("regions", function () {
      ...
      (i.innerText = "M"),
        ...
        (o.style.cssText = "width: 50px; height: 50px; padding: 42px;"),
        (o.style[A] = d),
        r.appendChild(i),
        r.appendChild(o),
    ...
    Modernizr.addTest("bdi", function () {
      ...
      var t =
        "rtl" ===
        (window.getComputedStyle ? getComputedStyle(e, null) : e.currentStyle)
          .direction;
    ...
    Modernizr.addTest("formattribute", function () {
      ...
      return (
        ...
        n.appendChild(t),
        docElement.appendChild(n),
        (i = e.elements && 1 === e.elements.length && t.form == e),
        n.parentNode.removeChild(n),
        i
      );
    }),
    ...
    Modernizr.addAsyncTest(function () {
      ...
      if (
        ...
        if (
          ...
          return t(s), r("blocked", a), void n(s);
        (o = function () {
          return (
            t(s),
    ...
    : testStyles(
        ...
        function (A, e) {
          var t = document.getElementById("smodernizr"),
            ...
            r = n
              ? n.cssRules && n.cssRules[0]
                ? n.cssRules[0].cssText
                : n.cssText || ""
              : "",
  ...
  (Modernizr.inputtypes = (function (A) {
    for (var e, t, n, r = A.length, i = "1)", o = 0; r > o; o++)
    ...
    Modernizr.addTest("localizednumber", function () {
      ...
      return (
        (A =
          "number" === r.type && 1.1 === r.valueAsNumber && r.checkValidity()),
        n.removeChild(e),
        t.fake && n.parentNode.removeChild(n),
        A
      );
    });
  ...
  Modernizr._q.push(function () {
    ...
    testStyles(
      ...
      function (A) {
        ...
        Modernizr.addTest(
          "cssvmaxunit",
          roundedEquals(d, a) || roundedEquals(d, a - r),
        );
      },
      3,
    ),
  ...
  Modernizr.addTest("crypto", !!prefixed("subtle", crypto)),
    ...
    Modernizr.addTest("forcetouch", function () {
      return hasEvent(prefixed("mouseforcewillbegin", window, !1), window)
    ...
    Modernizr.addAsyncTest(function () {
      ...
      try {
        var n,
          r,
          i = 'var hello = "world"',
          o = new Blob([i], { type: "text/javascript" }),
        ...
        (a.onerror = A),
          ...
          (n = new ArrayBuffer(1)),
          a.postMessage(n, [n]),
          addTest("transferables", 0 === n.byteLength),
          e();
      } catch (s) {
        A();
      }
        ...
        function t() {
          try {
            ...
            return (
              ...
              document.body.insertBefore(A, o),
              (t.cssText =
              ...
              (i = e.offsetHeight != n || e.offsetWidth != r),
        ...
        function r(A) {
          try {
            var e,
              ...
              o = document.body.firstElementChild || document.body.firstChild;
            (n.innerHTML = r + A + r),
              document.body.insertBefore(n, o),
            ...
            return (
              document.body.removeChild(n), document.body.removeChild(t), i
            );
          } catch (d) {
            return !1;
          }
