...
//! NOTE: `element.animate()` does *not* return a `Promise`: it returns an 
//!       `Animation` object with a `finished` property that is a `Promise`.

// Promise hell
// alice1?.animate(aliceTumbling, aliceTiming).finished.then(() => {
//   const aliceAnimation2 = alice2?.animate(aliceTumbling, aliceTiming).finished;
//   aliceAnimation2?.then(() => {
